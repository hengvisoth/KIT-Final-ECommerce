...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useStore();
    useRoute();
    const { data: products } = ([__temp, __restore] = withAsyncContext(() => useFetch("http://13.212.165.16:3002/api/products", "$PslAyef5YX")), __temp = await __temp, __restore(), __temp);
    const handleFollow = () => {
...
//# sourceMappingURL=index-e19820a0.mjs.map
