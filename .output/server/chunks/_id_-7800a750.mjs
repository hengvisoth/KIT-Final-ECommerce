...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: blog } = ([__temp, __restore] = withAsyncContext(() => useFetch(`http://13.212.165.16:3002/api/blog/${id}`, "$b6624wP6pv")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=_id_-7800a750.mjs.map
