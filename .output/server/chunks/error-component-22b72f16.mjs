import { ref, resolveComponent, withCtx, createTextVNode, unref, isRef, mergeProps, createVNode, openBlock, createBlock, useSSRContext } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_btn, mergeProps({
                          ...
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Report a problem `);
                            } else {
                              return [
                                createTextVNode(" Report a problem ")
                              ];
                            }
                          }),
                          _: 2
                        ...
                        _push4(ssrRenderComponent(_component_v_card, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_v_card_actions, { class: "d-flex justify-end" }, {
                              ...
                              return [
                                ...
                                createVNode(_component_v_card_actions, { class: "d-flex justify-end" }, {
                                  default: withCtx(() => [
                                    createVNode(_component_v_btn, {
                                      color: "#e5345b",
                                      onClick: handleSend
                  ...
                  return [
                    createVNode("div", { class: "main" }, [
                      (openBlock(), createBlock("svg", {
                        ...
                        createVNode("g", {
                          ...
                          createVNode("g", { transform: "translate(-448 -157) translate(448 157)" }, [
                            createVNode("mask", {
                              id: "prefix__b",
                              fill: "#fff"
                            }, [
                              createVNode("use", { "xlink:href": "#prefix__a" })
                            ]),
                            createVNode("use", {
                              fill: "#F6F6F7",
                            ...
                            createVNode("g", { class: "paes" }, [
                              createVNode("g", { class: "pao-baixo" }, [
                                createVNode("path", {
                                  fill: "#FBB965",
                    ...
                    createVNode("div", { class: "text-center" }, [
                      ...
                      createVNode("p", { class: "text-grey" }, " Sorry, the page you're looking for doesn't exist. "),
                      createVNode("p", { class: "text-grey" }, [
                        createTextVNode(" If you think something is broken, report a "),
                        createVNode("br"),
                        createTextVNode(" problem ")
                      ]),
            ...
            _push2(ssrRenderComponent(_component_v_snackbar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Thanks you for your report. We will fix it as soon as possible. `);
                } else {
                  return [
                    createTextVNode(" Thanks you for your report. We will fix it as soon as possible. ")
                  ];
                }
              }),
              _: 1
...
const error = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-24082298"]]);

export { error as default };
//# sourceMappingURL=error-component-22b72f16.mjs.map
