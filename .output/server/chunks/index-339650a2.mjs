...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const grid = ref(true);
    const { data: products } = ([__temp, __restore] = withAsyncContext(() => useFetch("http://13.212.165.16:3002/api/products", "$E1A2NJhK9u")), __temp = await __temp, __restore(), __temp);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_img, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-overlay" data-v-f35c635a${_scopeId3}><p class="text" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId3}>#Stay Home</p><p class="text-white text-center" data-aos="fade-up" data-aos-delay="500" data-v-f35c635a${_scopeId3}> Lorem ipsum dolor, sit amet consectetur adipisicing elit. </p></div>`);
                      } else {
                        return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          ssrRenderList(unref(styles), (l) => {
                                            _push7(`<div data-v-f35c635a${_scopeId6}>`);
                        ...
                        _push4(ssrRenderComponent(_component_v_col, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_v_carousel_item, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="text-overlayc" data-v-f35c635a${_scopeId6}><div data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}><span class="font-weight-bold text-white text-uppercase" style="${ssrRenderStyle({ "font-size": "80px" })}" data-v-f35c635a${_scopeId6}>Perfect</span><span class="ms-5 text-white text-uppercase" style="${ssrRenderStyle({ "font-size": "80px" })}" data-v-f35c635a${_scopeId6}>Design</span></div><p class="text-white" style="${ssrRenderStyle({ "font-size": "20px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}> Ready. experience. compfortable and indispensable in life </p>`);
                                    ...
                                    _push6(ssrRenderComponent(_component_v_carousel_item, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="text-overlayc" data-v-f35c635a${_scopeId6}><p data-aos="fade-right" data-aos-delay="500" class="font-weight-bold text-white" style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-f35c635a${_scopeId6}> New Arrivals 2023 </p><div data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}><span class="font-weight-bold text-white text-uppercase" style="${ssrRenderStyle({ "font-size": "80px" })}" data-v-f35c635a${_scopeId6}>Jacket</span><span class="ms-5 text-white text-uppercase" style="${ssrRenderStyle({ "font-size": "80px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}>Tech Pack</span></div><p class="text-white" style="${ssrRenderStyle({ "font-size": "20px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}> Aurora Shell Jacket is Ready For Any Adventure </p>`);
                                          _push7(ssrRenderComponent(_component_v_btn, {
                                            variant: "outlined",
                                            color: "white",
                                            class: "mt-10",
                                    ...
                                    _push6(ssrRenderComponent(_component_v_carousel_item, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="text-overlayc" data-v-f35c635a${_scopeId6}><div data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}><span class="font-weight-bold text-white" style="${ssrRenderStyle({ "font-size": "80px" })}" data-v-f35c635a${_scopeId6}>NIKE</span><span class="ms-5 text-white text-uppercase" style="${ssrRenderStyle({ "font-size": "80px" })}" data-v-f35c635a${_scopeId6}>Baseball</span></div><p class="text-white" style="${ssrRenderStyle({ "font-size": "20px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId6}> We&#39;ve handpicked our best gifts for all kinds of athleted. </p>`);
                                          _push7(ssrRenderComponent(_component_v_btn, {
                                            variant: "outlined",
                                            color: "white",
                                            class: "mt-10",
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_v_img, { src: "https://htmldemo.net/shome/shome/assets/img/shop/category/1.webp" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="text-overlays" data-v-f35c635a${_scopeId7}><p class="text-white text-center" style="${ssrRenderStyle({ "font-size": "25px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId7}> Sale 30% off </p><p class="text" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId7}> SPORTS SHOES </p></div>`);
                                              } else {
                                                return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_v_img, { src: "https://htmldemo.net/shome/shome/assets/img/shop/category/2.webp" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="text-overlays" data-v-f35c635a${_scopeId7}><p class="text-white text-center" style="${ssrRenderStyle({ "font-size": "25px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId7}> Sale 50% off </p><p class="text" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId7}> NEW ARRIVAL </p></div>`);
                                              } else {
                                                return [
                                                  createVNode("div", { class: "text-overlays" }, [
                                                    createVNode("p", {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_v_img, { src: "https://htmldemo.net/shome/shome/assets/img/shop/category/3.webp" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="text-overlays" data-v-f35c635a${_scopeId7}><p class="text-white text-center" style="${ssrRenderStyle({ "font-size": "25px" })}" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId7}> Sale 45% off </p><p class="text" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId7}> NEW SNEAKERS </p></div>`);
                                              } else {
                                                return [
                                                  createVNode("div", { class: "text-overlays" }, [
                                                    createVNode("p", {
                              ...
                              _push5(`<h1 class="fw-bold fadeRight mt-10" data-aos="fade-right" data-aos-delay="500" data-v-f35c635a${_scopeId4}> New Arrivals. <span style="${ssrRenderStyle({ "color": "#6b7280" })}" data-v-f35c635a${_scopeId4}>Best selling of the month</span></h1>`);
                              ...
                              _push5(`<div class="mt-8 d-flex justify-center" data-v-f35c635a${_scopeId4}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f35c635a"]]);

export { index as default };
//# sourceMappingURL=index-339650a2.mjs.map
