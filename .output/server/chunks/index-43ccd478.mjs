...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: blogs } = ([__temp, __restore] = withAsyncContext(() => useFetch("http://13.212.165.16:3002/api/blog", "$ansXcfZp0C")), __temp = await __temp, __restore(), __temp);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_img, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-overlay" data-v-41c0a49d${_scopeId3}><p class="text" data-aos="fade-up" data-aos-delay="500" data-v-41c0a49d${_scopeId3}>#Read More</p><p class="text-white text-center" data-aos="fade-right" data-aos-delay="500" data-v-41c0a49d${_scopeId3}> Lorem ipsum dolor, sit amet consectetur adipisicing elit. </p></div>`);
                      } else {
                        return [
            ...
            _push2(ssrRenderComponent(_component_v_container, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="fw-bold mt-10" data-aos="fade-right" data-aos-delay="500" data-v-41c0a49d${_scopeId2}> Blogs <span style="${ssrRenderStyle({ "color": "#6b7280" })}" data-v-41c0a49d${_scopeId2}>on latest fashion trends</span></h1>`);
                                      ...
                                      _push6(ssrRenderComponent(_component_v_card, null, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            _push7(`<div class="pa-5" data-v-41c0a49d${_scopeId6}><div class="d-flex" data-aos="fade-right" data-aos-delay="500" data-v-41c0a49d${_scopeId6}>`);
                                            _push7(ssrRenderComponent(_component_v_icon, { icon: "mdi-account-circle-outline" }, null, _parent7, _scopeId6));
                                            _push7(`<p class="ml-2" data-v-41c0a49d${_scopeId6}>Admin</p>`);
                                            ...
                                            _push7(`<p class="ml-2" data-v-41c0a49d${_scopeId6}>May 10, 2017</p>`);
                                            _push7(ssrRenderComponent(_component_v_divider, {
                                              vertical: "",
                                              class: "border-opacity-100 mx-5"
                                            }, null, _parent7, _scopeId6));
                                            _push7(ssrRenderComponent(_component_v_icon, { icon: "mdi-comment-text-outline" }, null, _parent7, _scopeId6));
                                            _push7(`<p class="ml-2" data-v-41c0a49d${_scopeId6}>2 Comments</p></div><p class="font-weight-bold mt-3" style="${ssrRenderStyle({ "font-size": "25px" })}" data-aos="fade-right" data-aos-delay="500" data-v-41c0a49d${_scopeId6}>${ssrInterpolate(b.title)}</p><p class="mt-3 article-text" data-aos="fade-right" data-aos-delay="500" data-v-41c0a49d${_scopeId6}>${ssrInterpolate(b.article)}</p><div class="mt-5" data-aos="fade-up" data-aos-delay="500" data-v-41c0a49d${_scopeId6}>`);
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_v_card, { class: "pa-3" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div data-v-41c0a49d${_scopeId5}><p style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-41c0a49d${_scopeId5}>Recent Article</p>`);
                                    ...
                                    ssrRenderList(unref(recent), (r) => {
                                      _push6(`<div class="d-flex mt-10" data-v-41c0a49d${_scopeId5}><div data-v-41c0a49d${_scopeId5}>`);
                                      ...
                                      _push6(`</div><div class="ms-3" data-v-41c0a49d${_scopeId5}><p style="${ssrRenderStyle({ "max-width": "160px" })}" data-v-41c0a49d${_scopeId5}>${ssrInterpolate(r.title)}</p></div></div>`);
                                    });
                                    _push6(`<!--]--><p class="mt-10" style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-41c0a49d${_scopeId5}>Tags</p>`);
                                    _push6(ssrRenderComponent(_component_v_divider, { class: "border-opacity-100 my-5" }, null, _parent6, _scopeId5));
                                    _push6(`<p data-v-41c0a49d${_scopeId5}>Dancing</p><p data-v-41c0a49d${_scopeId5}>Heel</p><p data-v-41c0a49d${_scopeId5}>Hiking</p><p data-v-41c0a49d${_scopeId5}>Racing</p><p data-v-41c0a49d${_scopeId5}>Running</p><p data-v-41c0a49d${_scopeId5}>Sneakers</p><p class="mt-10" style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-41c0a49d${_scopeId5}>Best Shoe</p>`);
                                    _push6(ssrRenderComponent(_component_v_divider, { class: "border-opacity-100 my-5" }, null, _parent6, _scopeId5));
                                    _push6(`<div class="my-10" data-v-41c0a49d${_scopeId5}>`);
                                    ...
                                    _push6(`<h2 class="mt-10 text-center" data-v-41c0a49d${_scopeId5}>Messi Addidas</h2>`);
                                    _push6(ssrRenderComponent(_component_v_divider, { class: "border-opacity-100 my-5" }, null, _parent6, _scopeId5));
                                    _push6(`<h2 data-v-41c0a49d${_scopeId5}>$275.00</h2>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-41c0a49d"]]);

export { index as default };
//# sourceMappingURL=index-43ccd478.mjs.map
